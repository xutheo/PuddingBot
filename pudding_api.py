...
def get_homework():
    ...
    worry_hw = Homework.get_homework2(clan="Worry", cache=True)
    chorry_hw = Homework.get_homework2(clan="Chorry", cache=True)
    borry_hw = Homework.get_homework2(clan="Borry", cache=True)
